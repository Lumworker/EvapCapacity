...
{
    /// <summary>
    /// Summary description for getData_Excel
    /// </summary>
    public class getData_Excel : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            string Directory = Path.GetFullPath(Path.Combine(webRootPath, "Excel/ExcelTemp.xlsx"));
